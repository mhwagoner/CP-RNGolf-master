class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.input.on('pointerdown', (pointer) => {
            ...
            this.ball.body.setVelocityX(Phaser.Math.Between(this.SHOT_VELOCITY_X, this.SHOT_VELOCITY_X * 2) * shotDirectionX)
        ...
        this.shotsText = this.add.text(10, 10, 'Shots: ' + this.shots, UIConfig)
        this.scoreText = this.add.text(10, 40, 'Score: ' + this.score, UIConfig)
        this.shotsPercentText = this.add.text(10, 70, 'Accuracy: ' + 0 + '%', UIConfig)
    }
    ...
    update() {
        ...
        this.shotsPercentText.text = 'Accuracy: ' + (Math.round(this.score/this.shots*100)) + '%'
    }
}
/*
CODE CHALLENGE
